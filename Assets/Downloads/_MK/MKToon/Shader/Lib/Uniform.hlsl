...
//////////////////////////////////////////////////////
	...
	CBUFFER_END
		...
		UNITY_DOTS_INSTANCING_START(UserPropertyMetadata)
			...
			UNITY_DOTS_INSTANCED_PROP(float, _Hue)
		...
		MK_DEFINE_CACHED_DOTS_INSTANCED_PROP(float, _Hue)
		...
		void SetupDOTSLitMaterialPropertyCaches()
		{
			...
			mk_DOTS_Cached_Contrast = MK_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _Hue);
		...
		#define _Contrast MK_SET_DOTS_INSTANCED_PROP(float, _Hue)
