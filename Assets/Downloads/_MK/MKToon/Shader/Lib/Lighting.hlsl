...
//////////////////////////////////////////////////////
	...
	#if UNITY_VERSION < 60000000 && defined(MK_URP) || defined(MK_LEGACY_RP)
	...
	#elif defined(MK_ARTISTIC_HATCHING)
		#define ARTISTIC_RAW_SHADOW_MASKED(value, shadowMask, compare) value = Hatching(surface.artistic0, surface.artistic1, value, _ArtisticShadowFilter) * step(HALF_MIN, compare)
	#elif defined(MK_ARTISTIC_SKETCH)
		#define ARTISTIC_RAW_SHADOW_MASKED(value, shadowMask, compare) value = Sketch(surface.artistic0, 1, lerp(_ArtisticShadowFilter, value, value)) * step(HALF_MIN, compare)
	#else
	...
	*/
	...
	// Lighting Direct
	/////////////////////////////////////////////////////////////////////////////////////////////
	inline half MKLightingDiffuse(inout Surface surface, in MKSurfaceData surfaceData, in MKPBSData pbsData, inout MKLight light, in MKLightData lightData)
	{
		#ifdef MK_LIT
			half diffuse;
			...
			//Lighting could be optimized by combining every component (diffuse, specular, lightTransmission, indirect/direct), may break gooch
				...
				ARTISTIC_RAW_SHADOW_MASKED(light.shadowAttenuation, saturate(1.0 - light.shadowAttenuation), light.distanceAttenuation);
	...
	inline void LightingDirectAdditional(inout Surface surface, in MKSurfaceData surfaceData, in MKPBSData pbsData, inout MKLight light, in MKLightData lightData, out half4 finalLightColor)
	{
		#ifdef MK_LIT
	...
	inline void LightingDirect(inout Surface surface, in MKSurfaceData surfaceData, in MKPBSData pbsData, in MKLight light, inout MKLightData lightData, out half4 finalLightColor)
	{
		#ifdef MK_LIT
			half diffuseRaw = MKLightingDiffuse(surface, surfaceData, pbsData, light, lightData);
			half4 diffuse = half4(0, 0, 0, diffuseRaw);
