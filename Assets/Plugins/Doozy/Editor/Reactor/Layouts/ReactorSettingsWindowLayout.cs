...
{
    public sealed class ReactorSettingsWindowLayout : FluidWindowLayout, IDashboardSettingsWindowLayout
    {
        public int order => 0;
        
        public override string layoutName => "Reactor Settings";
        public override List<Texture2D> animatedIconTextures => EditorSpriteSheets.Reactor.Icons.ReactorIcon;
