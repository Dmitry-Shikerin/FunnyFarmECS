...
namespace Doozy.Editor.Reactor.Windows
{
    public class ReactorWindow : FluidWindow<ReactorWindow>
    {
        ...
        [MenuItem("Tools/Doozy/Refresh/Reactor", priority = -450)]
        public static void RefreshDatabase() => UIAnimationPresetDatabase.instance.RefreshDatabase();
        ...
        protected override void CreateGUI()
        {
            ...
            sideMenu
                ...
                .AddChild(runtimeTickerVisualizer = new TickerVisualizer(TickerVisualizer.TickerType.Runtime, ReactorRuntimeTickerWindow.Open).SetStyleBorderRadius(8, 8, 0, 0))
                .AddSpace(0, DesignUtils.k_Spacing)
                .AddChild(editorTickerVisualizer = new TickerVisualizer(TickerVisualizer.TickerType.Editor, ReactorEditorTickerWindow.Open).SetStyleBorderRadius(0, 0, 8, 8));
