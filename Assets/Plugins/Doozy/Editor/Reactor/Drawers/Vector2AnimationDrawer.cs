...
{
    [CustomPropertyDrawer(typeof(Vector2Animation), true)]
    public class Vector2AnimationDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            FluidComponentHeader componentHeader =
                FluidComponentHeader.Get()
                    ...
                    .SetComponentNameText("Reflected Vector2")
        ...
        private static VisualElement GetAnimationContent(SerializedProperty propertyAnimation, SerializedProperty propertyAnimationEnabled)
        {
            ...
            FluidField fromOffsetFluidField = FluidField.Get<Vector2Field>(propertyFromOffset, "From Offset").SetStyleHeight(height, height, height);
            FluidField toOffsetFluidField = FluidField.Get<Vector2Field>(propertyToOffset, "To Offset").SetStyleHeight(height, height, height);

            FluidField fromCustomValueFluidField = FluidField.Get<Vector2Field>(propertyFromCustomValue, "From Custom Value").SetStyleHeight(height, height, height);
            FluidField toCustomValueFluidField = FluidField.Get<Vector2Field>(propertyToCustomValue, "To Custom Value").SetStyleHeight(height, height, height);
