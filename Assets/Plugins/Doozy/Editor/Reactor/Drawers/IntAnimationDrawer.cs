...
{
    [CustomPropertyDrawer(typeof(IntAnimation), true)]
    public class IntAnimationDrawer : PropertyDrawer
    {
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            FluidComponentHeader componentHeader =
                FluidComponentHeader.Get()
                    ...
                    .SetComponentNameText("Reflected Int")
        ...
        private static VisualElement GetAnimationContent(SerializedProperty propertyAnimation, SerializedProperty propertyAnimationEnabled)
        {
            ...
            FluidField fromOffsetFluidField = FluidField.Get<IntegerField>(propertyFromOffset, "From Offset").SetStyleHeight(height, height, height);
            FluidField toOffsetFluidField = FluidField.Get<IntegerField>(propertyToOffset, "To Offset").SetStyleHeight(height, height, height);

            FluidField fromCustomValueFluidField = FluidField.Get<IntegerField>(propertyFromCustomValue, "From Custom Value").SetStyleHeight(height, height, height);
            FluidField toCustomValueFluidField = FluidField.Get<IntegerField>(propertyToCustomValue, "To Custom Value").SetStyleHeight(height, height, height);
