...
namespace Doozy.Editor.Reactor.Editors.Targets
{
    ...
    {
        public override IEnumerable<Texture2D> targetIconTextures => EditorSpriteSheets.Reactor.Icons.TextProgressTarget;
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                ...
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.Reactor.Targets.ProgressTargets.TextProgressTarget.html")
                .AddYouTubeButton();
