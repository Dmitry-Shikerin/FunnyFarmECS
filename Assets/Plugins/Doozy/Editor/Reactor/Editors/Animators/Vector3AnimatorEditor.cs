...
{
    [CustomEditor(typeof(Vector3Animator))]
    [CanEditMultipleObjects]
    public class Vector3AnimatorEditor : ReflectedValueAnimatorEditor
    {
        private Vector3Animator castedTarget => (Vector3Animator)target;
        private List<Vector3Animator> castedTargets => targets.Cast<Vector3Animator>().ToList();
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetComponentNameText("Vector3 Animator")
        ...
        protected override void InitializeAnimation()
        {
            ...
            animationTab.SetIcon(EditorSpriteSheets.Reactor.Icons.Vector3Animation);
