...
namespace Doozy.Editor.Reactor.Editors.Animators
{
    ...
    public class FloatAnimatorEditor : ReflectedValueAnimatorEditor
    {
        private FloatAnimator castedTarget => (FloatAnimator)target;
        private List<FloatAnimator> castedTargets => targets.Cast<FloatAnimator>().ToList();
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetComponentNameText("Float Animator")
        ...
        protected override void InitializeAnimation()
        {
            ...
            animationTab.SetIcon(EditorSpriteSheets.Reactor.Icons.FloatAnimation);
