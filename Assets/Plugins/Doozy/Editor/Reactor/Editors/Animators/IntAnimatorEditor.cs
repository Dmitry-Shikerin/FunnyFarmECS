...
{
    [CustomEditor(typeof(IntAnimator))]
    [CanEditMultipleObjects]
    public class IntAnimatorEditor : ReflectedValueAnimatorEditor
    {
        private IntAnimator castedTarget => (IntAnimator)target;
        private List<IntAnimator> castedTargets => targets.Cast<IntAnimator>().ToList();
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetComponentNameText("Int Animator")
        ...
        protected override void InitializeAnimation()
        {
            ...
            animationTab.SetIcon(EditorSpriteSheets.Reactor.Icons.IntAnimation);
