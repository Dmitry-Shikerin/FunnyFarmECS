...
namespace Doozy.Editor.Common.Layouts
{
    public class CategoryNameItemNameRow : PoolableElement<CategoryNameItemNameRow>
    {
        ...
        public static CategoryNameItemNameRow Get
        (
            CategoryNameItem categoryNameItem,
            Func<CategoryNameItem, string, bool> saveCallback,
            UnityAction<CategoryNameItem> removeCallback
        )
            => Get()
                .SetTarget(categoryNameItem)
                .SetSaveHandler(saveCallback)
                .SetRemoveHandler(removeCallback);
