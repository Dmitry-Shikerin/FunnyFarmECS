...
{
    [CustomPropertyDrawer(typeof(SimpleModyAction), true)]
    public class SimpleModyActionDrawer : BaseModyActionDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            var modyAction = property.GetTargetObjectOfProperty() as SimpleModyAction;
