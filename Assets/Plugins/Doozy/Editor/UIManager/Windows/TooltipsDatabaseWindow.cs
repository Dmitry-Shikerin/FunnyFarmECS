...
{
    public class TooltipsDatabaseWindow : FluidWindow<TooltipsDatabaseWindow>
    {
        private const string WINDOW_TITLE = "Tooltips Database";
        ...
        [MenuItem("Tools/Doozy/Refresh/Database/Tooltips", priority = -450)]
        private static void RefreshDatabase() => UITooltipDatabase.instance.RefreshDatabase();
        
        protected override void CreateGUI()
        {
            windowLayout?.RecycleAndClear();
            windowLayout = new TooltipsDatabaseWindowLayout();
            root
                .RecycleAndClear()
