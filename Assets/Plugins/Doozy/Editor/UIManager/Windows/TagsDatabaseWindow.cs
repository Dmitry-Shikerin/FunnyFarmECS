...
{
    public class TagsDatabaseWindow: FluidWindow<TagsDatabaseWindow>
    {
        private const string WINDOW_TITLE = "Tags Database";
        ...
        {
            windowLayout = new TagsDatabaseWindowLayout();
            root
                .RecycleAndClear()
