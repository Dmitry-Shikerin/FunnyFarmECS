...
{
    public class SteppersDatabaseWindow : FluidWindow<SteppersDatabaseWindow>
    {
        private const string WINDOW_TITLE = "Steppers Database";
        ...
        {
            windowLayout = new SteppersDatabaseWindowLayout();
            root
                .RecycleAndClear()
