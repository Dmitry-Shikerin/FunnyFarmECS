...
namespace Doozy.Editor.UIManager.Editors.Containers.Internal
{
    public abstract class BaseUIContainerEditor : UnityEditor.Editor
    {
        ...
        protected SerializedProperty propertyHandleCanvasGroupBlockRaycasts { get; set; }
        ...
        protected virtual void FindProperties()
        {
            ...
            propertyHandleCanvasGroupBlockRaycasts = serializedObject.FindProperty(nameof(UIContainer.HandleCanvasGroupBlockRaycasts));
        ...
        protected virtual void InitializeSettings()
        {
            ...
            settingsAnimatedContainer.SetOnShowCallback(() =>
            {
                ...
                #region Handle CanvasGroup Block Raycasts

                FluidToggleSwitch handleCanvasGroupBlockRaycastsSwitch =
                    FluidToggleSwitch.Get()
                        .BindToProperty(propertyHandleCanvasGroupBlockRaycasts)
                        .SetToggleAccentColor(selectableAccentColor)
                        .SetLabelText("Handle CanvasGroup Block Raycasts")
                        .SetTooltip("If TRUE, the Block Raycasts option of the CanvasGroup component found on the same GameObject this component is attached to, will be disabled/enabled when Show/Hide is called");
                
                FluidField handleCanvasGroupBlockRaycastsFluidField =
                    FluidField.Get()
                        .AddFieldContent(handleCanvasGroupBlockRaycastsSwitch);
                ...
                settingsAnimatedContainer
                    ...
                    .AddContent(DesignUtils.spaceBlock)
                    .AddContent(handleCanvasGroupBlockRaycastsFluidField)
                    .AddContent(DesignUtils.spaceBlock)
                    .AddContent
                    (
                        DesignUtils.row
