...
{
    [CustomEditor(typeof(UIStepperValueTrigger), true)]
    [CanEditMultipleObjects]
    public class UIStepperValueTriggerEditor : BaseValueTriggerEditor<UIStepper>
    {
        protected override VisualElement GetTargetObjectField()
        {
            ObjectField targetObjectField = 
                DesignUtils.NewObjectField(propertyTarget, typeof(UIStepper))
                    .SetTooltip("Target UIStepper")
                    .SetStyleFlexGrow(1);
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetSecondaryIcon(EditorSpriteSheets.UIManager.Icons.UIStepper)
