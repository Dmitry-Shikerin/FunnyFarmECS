...
namespace Doozy.Editor.UIManager.Editors.Triggers
{
    ...
    public class PointerMiddleClickTriggerEditor : ModyTriggerEditor<PointerMiddleClickTrigger>
    {
        ...
        {
            base.FindProperties();
            propertyOnTrigger = serializedObject.FindProperty(nameof(PointerMiddleClickTrigger.OnTrigger));
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetSecondaryIcon(EditorSpriteSheets.EditorUI.Icons.ButtonMiddleClick)
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.UIManager.Triggers.PointerMiddleClickTrigger.html")
                .AddYouTubeButton();
        ...
        protected override void InitializeCallbacks()
        {
            ...
            callbacksAnimatedContainer.SetOnShowCallback(() =>
            {
                callbacksAnimatedContainer
                    ...
                    (
                        FluidField.Get()
                            .AddFieldContent(DesignUtils.UnityEventField("Called when pointer middle button is clicked over the trigger", propertyOnTrigger))
                    )
