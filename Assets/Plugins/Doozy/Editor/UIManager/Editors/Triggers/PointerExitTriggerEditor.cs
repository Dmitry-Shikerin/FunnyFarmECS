...
namespace Doozy.Editor.UIManager.Editors.Triggers
{
    ...
    public class PointerExitTriggerEditor : ModyTriggerEditor<PointerExitTrigger>
    {
        ...
        {
            base.FindProperties();
            propertyOnTrigger = serializedObject.FindProperty(nameof(PointerExitTrigger.OnTrigger));
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetSecondaryIcon(EditorSpriteSheets.EditorUI.Icons.PointerExit)
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.UIManager.Triggers.PointerExitTrigger.html")
                .AddYouTubeButton();
        ...
        protected override void InitializeCallbacks()
        {
            ...
            callbacksAnimatedContainer.SetOnShowCallback(() =>
            {
                callbacksAnimatedContainer
                    ...
                    (
                        FluidField.Get()
                            .AddFieldContent(DesignUtils.UnityEventField("Called when the pointer exits the trigger", propertyOnTrigger))
                    )
