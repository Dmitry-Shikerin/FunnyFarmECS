...
namespace Doozy.Editor.UIManager.Editors.Triggers
{
    ...
    public class UISubmitTriggerEditor : ModyTriggerEditor<UISubmitTrigger>
    {
        ...
        {
            base.FindProperties();
            propertyOnTrigger = serializedObject.FindProperty(nameof(UISubmitTrigger.OnTrigger));
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetSecondaryIcon(EditorSpriteSheets.EditorUI.Icons.Border)
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.UIManager.Triggers.UISubmitTrigger.html")
                .AddYouTubeButton();
        ...
        protected override void InitializeCallbacks()
        {
            ...
            callbacksAnimatedContainer.SetOnShowCallback(() =>
            {
                callbacksAnimatedContainer
                    ...
                    (
                        FluidField.Get()
                            .AddFieldContent(DesignUtils.UnityEventField("Called when a 'Submit' event has been received", propertyOnTrigger))
                    )
