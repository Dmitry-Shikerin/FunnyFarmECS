...
namespace Doozy.Editor.UIManager.Editors.Triggers
{
    ...
    public class PointerUpTriggerEditor : ModyTriggerEditor<PointerUpTrigger>
    {
        ...
        {
            base.FindProperties();
            propertyOnTrigger = serializedObject.FindProperty(nameof(PointerUpTrigger.OnTrigger));
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetSecondaryIcon(EditorSpriteSheets.EditorUI.Icons.PointerUp)
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.UIManager.Triggers.PointerUpTrigger.html")
                .AddYouTubeButton();
        ...
        protected override void InitializeCallbacks()
        {
            ...
            callbacksAnimatedContainer.SetOnShowCallback(() =>
            {
                callbacksAnimatedContainer
                    ...
                    (
                        FluidField.Get()
                            .AddFieldContent(DesignUtils.UnityEventField("Called when the pointer is released", propertyOnTrigger))
                    )
