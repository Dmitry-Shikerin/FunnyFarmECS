...
{
    [CustomEditor(typeof(PointerDownTrigger))]
    public class PointerDownTriggerEditor : ModyTriggerEditor<PointerDownTrigger>
    {
        ...
        {
            base.FindProperties();
            propertyOnTrigger = serializedObject.FindProperty(nameof(PointerDownTrigger.OnTrigger));
        }
        ...
        protected override void InitializeEditor()
        {
            ...
            componentHeader
                .SetSecondaryIcon(EditorSpriteSheets.EditorUI.Icons.PointerDown)
                .AddManualButton()
                .AddApiButton("https://api.doozyui.com/api/Doozy.Runtime.UIManager.Triggers.PointerDownTrigger.html")
                .AddYouTubeButton();
        ...
        protected override void InitializeCallbacks()
        {
            ...
            callbacksAnimatedContainer.SetOnShowCallback(() =>
            {
                callbacksAnimatedContainer
                    ...
                    (
                        FluidField.Get()
                            .AddFieldContent(DesignUtils.UnityEventField("Called when a pointer is pressed over the trigger", propertyOnTrigger))
                    )
