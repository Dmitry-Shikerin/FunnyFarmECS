...
{
    [CustomEditor(typeof(UISelectableFloatAnimator), true)]
    [CanEditMultipleObjects]
    public class UISelectableFloatAnimatorEditor : BaseUISelectableAnimatorEditor
    {
        public UISelectableFloatAnimator castedTarget => (UISelectableFloatAnimator)target;
        public List<UISelectableFloatAnimator> castedTargets => targets.Cast<UISelectableFloatAnimator>().ToList();
        ...
        {
            base.FindProperties();
            propertyValueTarget = serializedObject.FindProperty(nameof(UISelectableFloatAnimator.ValueTarget));
        }
