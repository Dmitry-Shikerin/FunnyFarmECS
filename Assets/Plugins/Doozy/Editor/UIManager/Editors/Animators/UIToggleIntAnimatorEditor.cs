...
{
    [CustomEditor(typeof(UIToggleIntAnimator))]
    [CanEditMultipleObjects]
    public class UIToggleIntAnimatorEditor : BaseUIToggleAnimatorEditor
    {
        public UIToggleIntAnimator castedTarget => (UIToggleIntAnimator) target;
        public List<UIToggleIntAnimator> castedTargets => targets.Cast<UIToggleIntAnimator>().ToList();
        ...
        protected override void FindProperties()
        {
            ...
            propertyValueTarget = serializedObject.FindProperty(nameof(UIToggleIntAnimator.ValueTarget));
        }
