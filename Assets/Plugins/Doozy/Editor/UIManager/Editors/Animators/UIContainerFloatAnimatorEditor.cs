...
{
    [CustomEditor(typeof(UIContainerFloatAnimator), true)]
    [CanEditMultipleObjects]
    public class UIContainerFloatAnimatorEditor : BaseUIContainerAnimatorEditor
    {
        private UIContainerFloatAnimator castedTarget => (UIContainerFloatAnimator) target;
        private List<UIContainerFloatAnimator> castedTargets => targets.Cast<UIContainerFloatAnimator>().ToList();
        ...
        protected override void FindProperties()
        {
            ...
            propertyValueTarget = serializedObject.FindProperty(nameof(UIContainerFloatAnimator.ValueTarget));
        }
