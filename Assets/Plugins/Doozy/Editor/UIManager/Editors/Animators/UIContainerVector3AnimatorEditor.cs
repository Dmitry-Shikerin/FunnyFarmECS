...
{
    [CustomEditor(typeof(UIContainerVector3Animator), true)]
    [CanEditMultipleObjects]
    public class UIContainerVector3AnimatorEditor : BaseUIContainerAnimatorEditor
    {
        private UIContainerVector3Animator castedTarget => (UIContainerVector3Animator) target;
        private List<UIContainerVector3Animator> castedTargets => targets.Cast<UIContainerVector3Animator>().ToList();
        ...
        protected override void FindProperties()
        {
            ...
            propertyValueTarget = serializedObject.FindProperty(nameof(UIContainerVector3Animator.ValueTarget));
        }
