...
{
    [CustomEditor(typeof(UISelectableVector2Animator), true)]
    [CanEditMultipleObjects]
    public class UISelectableVector2AnimatorEditor : BaseUISelectableAnimatorEditor
    {
        public UISelectableVector2Animator castedTarget => (UISelectableVector2Animator)target;
        public List<UISelectableVector2Animator> castedTargets => targets.Cast<UISelectableVector2Animator>().ToList();
        ...
        {
            base.FindProperties();
            propertyValueTarget = serializedObject.FindProperty(nameof(UISelectableVector2Animator.ValueTarget));
        }
