...
{
    [CustomEditor(typeof(UIToggleVector2Animator))]
    [CanEditMultipleObjects]
    public class UIToggleVector2AnimatorEditor : BaseUIToggleAnimatorEditor
    {
        public UIToggleVector2Animator castedTarget => (UIToggleVector2Animator) target;
        public List<UIToggleVector2Animator> castedTargets => targets.Cast<UIToggleVector2Animator>().ToList();
        ...
        protected override void FindProperties()
        {
            ...
            propertyValueTarget = serializedObject.FindProperty(nameof(UIToggleVector2Animator.ValueTarget));
        }
