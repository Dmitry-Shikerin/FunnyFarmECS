...
{
    [CustomEditor(typeof(UIToggleVector3Animator))]
    [CanEditMultipleObjects]
    public class UIToggleVector3AnimatorEditor : BaseUIToggleAnimatorEditor
    {
        public UIToggleVector3Animator castedTarget => (UIToggleVector3Animator) target;
        public List<UIToggleVector3Animator> castedTargets => targets.Cast<UIToggleVector3Animator>().ToList();
        ...
        protected override void FindProperties()
        {
            ...
            propertyValueTarget = serializedObject.FindProperty(nameof(UIToggleVector3Animator.ValueTarget));
        }
