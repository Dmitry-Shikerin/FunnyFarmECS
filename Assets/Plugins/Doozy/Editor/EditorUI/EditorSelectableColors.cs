    ...
    public static class EditorSelectableColors
    {
        ...
        public static class Brands
        {
            ...
            private static EditorDataSelectableColorPalette selectableColorPalette =>
                s_selectableColorPalette != null
                    ? s_selectableColorPalette
                    : s_selectableColorPalette = EditorDataSelectableColorDatabase.GetSelectableColorPalette("Brands");
            ...
            private static EditorSelectableColorInfo s_Discord;
            public static EditorSelectableColorInfo Discord => s_Discord ?? (s_Discord = GetSelectableColorInfo(ColorName.Discord));
            private static EditorSelectableColorInfo s_Facebook;
            public static EditorSelectableColorInfo Facebook => s_Facebook ?? (s_Facebook = GetSelectableColorInfo(ColorName.Facebook));
            private static EditorSelectableColorInfo s_Twitter;
            public static EditorSelectableColorInfo Twitter => s_Twitter ?? (s_Twitter = GetSelectableColorInfo(ColorName.Twitter));
            private static EditorSelectableColorInfo s_YouTube;
            public static EditorSelectableColorInfo YouTube => s_YouTube ?? (s_YouTube = GetSelectableColorInfo(ColorName.YouTube));
        ...
        public static class UIMenu
        {
            ...
            private static EditorDataSelectableColorPalette selectableColorPalette =>
                s_selectableColorPalette != null
                    ? s_selectableColorPalette
                    : s_selectableColorPalette = EditorDataSelectableColorDatabase.GetSelectableColorPalette("UIMenu");
