        ...
        private static void RefreshDatabase()
        {
            if (EditorUtility.DisplayDialog
                (
                    ...
                    "This will regenerate the database with the latest registered textures, from the source files." +
                    "\n\n" +
