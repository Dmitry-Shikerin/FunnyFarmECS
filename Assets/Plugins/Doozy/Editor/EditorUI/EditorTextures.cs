    ...
    public static class EditorTextures
    {
        ...
        public static class Dashboard
        {
            public static class Backgrounds
            {
                ...
                private static EditorDataTextureGroup textureGroup =>
                    s_textureGroup
                        ? s_textureGroup
                        : s_textureGroup = EditorDataTextureDatabase.GetTextureGroup("Dashboard","Backgrounds");
        ...
        public static class EditorUI
        {
            ...
            public static class Icons
            {
                ...
                public static Texture2D Discord => s_Discord ? s_Discord : s_Discord = GetTexture2D(TextureName.Discord);
                private static Texture2D s_DoozyUI;
                public static Texture2D DoozyUI => s_DoozyUI ? s_DoozyUI : s_DoozyUI = GetTexture2D(TextureName.DoozyUI);
                private static Texture2D s_DotNet;
                public static Texture2D DotNet => s_DotNet ? s_DotNet : s_DotNet = GetTexture2D(TextureName.DotNet);
                private static Texture2D s_Drag;
                public static Texture2D Drag => s_Drag ? s_Drag : s_Drag = GetTexture2D(TextureName.Drag);
                ...
                private static Texture2D s_Store;
                public static Texture2D Store => s_Store ? s_Store : s_Store = GetTexture2D(TextureName.Store);
                ...
                private static Texture2D s_Twitter;
                public static Texture2D Twitter => s_Twitter ? s_Twitter : s_Twitter = GetTexture2D(TextureName.Twitter);
        ...
        public static class Reactor
        {
            ...
            public static class Icons
            {
                ...
                private static Texture2D s_ProgressorDatabase;
                public static Texture2D ProgressorDatabase => s_ProgressorDatabase ? s_ProgressorDatabase : s_ProgressorDatabase = GetTexture2D(TextureName.ProgressorDatabase);
        ...
        public static class UIDesigner
        {
            public static class Icons
            {
                ...
                private static Texture2D s_UIRescaler;
                public static Texture2D UIRescaler => s_UIRescaler ? s_UIRescaler : s_UIRescaler = GetTexture2D(TextureName.UIRescaler);
        ...
        public static class UIManager
        {
            public static class Icons
            {
                ...
                private static Texture2D s_OrientationDetector;
                public static Texture2D OrientationDetector => s_OrientationDetector ? s_OrientationDetector : s_OrientationDetector = GetTexture2D(TextureName.OrientationDetector);
                ...
                private static Texture2D s_UIAlarm;
                public static Texture2D UIAlarm => s_UIAlarm ? s_UIAlarm : s_UIAlarm = GetTexture2D(TextureName.UIAlarm);
                ...
                private static Texture2D s_UIClock;
                public static Texture2D UIClock => s_UIClock ? s_UIClock : s_UIClock = GetTexture2D(TextureName.UIClock);
                ...
                private static Texture2D s_UIPopup;
                public static Texture2D UIPopup => s_UIPopup ? s_UIPopup : s_UIPopup = GetTexture2D(TextureName.UIPopup);
                private static Texture2D s_UIPopupDatabase;
                public static Texture2D UIPopupDatabase => s_UIPopupDatabase ? s_UIPopupDatabase : s_UIPopupDatabase = GetTexture2D(TextureName.UIPopupDatabase);
                private static Texture2D s_UIPopupLink;
                public static Texture2D UIPopupLink => s_UIPopupLink ? s_UIPopupLink : s_UIPopupLink = GetTexture2D(TextureName.UIPopupLink);
                private static Texture2D s_UIPopupManager;
                public static Texture2D UIPopupManager => s_UIPopupManager ? s_UIPopupManager : s_UIPopupManager = GetTexture2D(TextureName.UIPopupManager);
                ...
                private static Texture2D s_UIStepper;
                public static Texture2D UIStepper => s_UIStepper ? s_UIStepper : s_UIStepper = GetTexture2D(TextureName.UIStepper);
                private static Texture2D s_UIStepperDatabase;
                public static Texture2D UIStepperDatabase => s_UIStepperDatabase ? s_UIStepperDatabase : s_UIStepperDatabase = GetTexture2D(TextureName.UIStepperDatabase);
                private static Texture2D s_UIStopwatch;
                public static Texture2D UIStopwatch => s_UIStopwatch ? s_UIStopwatch : s_UIStopwatch = GetTexture2D(TextureName.UIStopwatch);
                private static Texture2D s_UITab;
                public static Texture2D UITab => s_UITab ? s_UITab : s_UITab = GetTexture2D(TextureName.UITab);
                private static Texture2D s_UITag;
                public static Texture2D UITag => s_UITag ? s_UITag : s_UITag = GetTexture2D(TextureName.UITag);
                private static Texture2D s_UITagDatabase;
                public static Texture2D UITagDatabase => s_UITagDatabase ? s_UITagDatabase : s_UITagDatabase = GetTexture2D(TextureName.UITagDatabase);
                private static Texture2D s_UITimer;
                public static Texture2D UITimer => s_UITimer ? s_UITimer : s_UITimer = GetTexture2D(TextureName.UITimer);
                ...
                private static Texture2D s_UITooltip;
                public static Texture2D UITooltip => s_UITooltip ? s_UITooltip : s_UITooltip = GetTexture2D(TextureName.UITooltip);
                private static Texture2D s_UITooltipDatabase;
                public static Texture2D UITooltipDatabase => s_UITooltipDatabase ? s_UITooltipDatabase : s_UITooltipDatabase = GetTexture2D(TextureName.UITooltipDatabase);
                private static Texture2D s_UITooltipLink;
                public static Texture2D UITooltipLink => s_UITooltipLink ? s_UITooltipLink : s_UITooltipLink = GetTexture2D(TextureName.UITooltipLink);
                ...
                private static Texture2D s_ValueTrigger;
                public static Texture2D ValueTrigger => s_ValueTrigger ? s_ValueTrigger : s_ValueTrigger = GetTexture2D(TextureName.ValueTrigger);
        ...
        public static class UIMenuIcons
        {
            public static class UIMenu
            {
                ...
                private static Texture2D s_UIElements;
                public static Texture2D UIElements => s_UIElements ? s_UIElements : s_UIElements = GetTexture2D(TextureName.UIElements);
