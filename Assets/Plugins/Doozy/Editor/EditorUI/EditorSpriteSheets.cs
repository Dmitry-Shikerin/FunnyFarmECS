    ...
    public static class EditorSpriteSheets
    {
        ...
        public static class UIManager
        {
            public static class Icons
            {
                ...
                public static List<Texture2D> OrientationDetector => GetTextures(SpriteSheetName.OrientationDetector);
            ...
            public static class UIMenu
            {
                ...
                public static List<Texture2D> UIElements => GetTextures(SpriteSheetName.UIElements);
