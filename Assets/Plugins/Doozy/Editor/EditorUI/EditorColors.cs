    ...
    public static class EditorColors
    {
        ...
        public static class Brands
        {
            ...
            private static EditorDataColorPalette colorPalette =>
                s_colorPalette != null
                    ? s_colorPalette
                    : s_colorPalette = EditorDataColorDatabase.GetColorPalette("Brands");
            ...
            private static Color? s_Discord;
            public static Color Discord => (Color) (s_Discord ?? (s_Discord = GetColor(ColorName.Discord)));
            private static Color? s_Facebook;
            public static Color Facebook => (Color) (s_Facebook ?? (s_Facebook = GetColor(ColorName.Facebook)));
            private static Color? s_Twitter;
            public static Color Twitter => (Color) (s_Twitter ?? (s_Twitter = GetColor(ColorName.Twitter)));
            private static Color? s_YouTube;
            public static Color YouTube => (Color) (s_YouTube ?? (s_YouTube = GetColor(ColorName.YouTube)));
        ...
        public static class UIMenu
        {
            ...
            private static EditorDataColorPalette colorPalette =>
                s_colorPalette != null
                    ? s_colorPalette
                    : s_colorPalette = EditorDataColorDatabase.GetColorPalette("UIMenu");
