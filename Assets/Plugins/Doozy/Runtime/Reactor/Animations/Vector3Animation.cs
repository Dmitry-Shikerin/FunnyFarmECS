...
namespace Doozy.Runtime.Reactor.Animations
{
    ...
    public class Vector3Animation : ReactorAnimation
    {
        ...
        /// <summary> Checks if the value target is valid </summary>
        public override bool hasTarget => valueTarget != null && valueTarget.IsValid();
        
        [SerializeField] private ReflectedVector3Reaction Animation;
        /// <summary> Vector3 reaction designed to animate a float value over time </summary>
