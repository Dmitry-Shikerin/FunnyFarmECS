...
{
    /// <summary>
    /// Specialized Reactor class that allows you to animate any public int field or property of any object via Reactor.
    /// </summary>
    [AddComponentMenu("Reactor/Animators/Int Animator")]
    public class IntAnimator : ReflectedValueAnimator
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/Reactor/Animators/Int Animator", false, 6)]
        private static void CreateComponent(UnityEditor.MenuCommand menuCommand)
        {
            GameObjectUtils.AddToScene<IntAnimator>(false, true);
        }
        #endif
        ...
        [SerializeField] private IntAnimation Animation;
        /// <summary> Int Animation </summary>
        public new IntAnimation animation => Animation ?? (Animation = new IntAnimation(ValueTarget));
        #pragma warning restore CS0109

        #if UNITY_EDITOR
        private void Reset()
        {
            Animation ??= new IntAnimation(ValueTarget);
            ResetAnimation();
        }
        #endif
