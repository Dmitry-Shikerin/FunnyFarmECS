...
namespace Doozy.Runtime.UIManager.Listeners
{
    ...
    {
        #if UNITY_EDITOR
        [UnityEditor.MenuItem("GameObject/UI/Components/Listeners/UIButton Listener", false, 8)]
        private static void CreateComponent(UnityEditor.MenuCommand menuCommand)
        {
            GameObjectUtils.AddToScene<UIButtonListener>("UIButton Listener", false, true);
        }
        #endif
