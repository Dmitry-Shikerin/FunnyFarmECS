...
namespace MegaFiers
{
	[CustomEditor(typeof(MegaAttachWrap))]
	public class MegaAttachWrapEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			MegaAttachWrap mod = (MegaAttachWrap)target;

			MegaEditorGUILayout.WrapObject(target, "Target", ref mod.target, true);
