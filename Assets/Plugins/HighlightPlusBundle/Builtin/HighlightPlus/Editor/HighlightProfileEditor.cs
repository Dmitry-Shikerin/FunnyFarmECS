...
namespace HighlightPlus {
    ...
    public class HighlightProfileEditor : Editor {
        ...
        SerializedProperty fadeInDuration, fadeOutDuration, constantWidth, minimumWidth;
        SerializedProperty outline, outlineColor, outlineColorStyle, outlineGradient, outlineGradientInLocalSpace, outlineWidth, outlineBlurPasses, outlineQuality, outlineEdgeMode, outlineEdgeThreshold, outlineDownsampling, outlineOptimalBlit, outlineVisibility, outlineIndependent, outlineContourStyle, outlineSharpness;
        SerializedProperty glow, glowWidth, glowQuality, glowBlurMethod, glowOptimalBlit, glowDownsampling, glowHQColor, glowDithering, glowDitheringStyle, glowMagicNumber1, glowMagicNumber2, glowAnimationSpeed, glowVisibility, glowBlendMode, glowBlendPasses, glowPasses, glowIgnoreMask;
