...
namespace HighlightPlus {
    ...
    public static class ShaderParams {
        ...
        public static int ZShift = Shader.PropertyToID("_ZShift");
        ...
        public static int OutlineStencilCompareFunction = Shader.PropertyToID("_OutlineStencilComp");
        ...
        public static int SeeThroughBorderMinimumWidth = Shader.PropertyToID("_SeeThroughBorderMinimumWidth");
