        ...
        public void UpdateMaterialProperties() {
            ...
            if (useSmoothGlow) {
                ...
                if (glowBlendMode == GlowBlendMode.Additive) {
                    fxMatComposeGlow.SetInt(ShaderParams.BlendSrc, (int)UnityEngine.Rendering.BlendMode.One);
                    fxMatComposeGlow.SetInt(ShaderParams.BlendDst, (int)UnityEngine.Rendering.BlendMode.One);
                } else {
                    fxMatComposeGlow.SetInt(ShaderParams.BlendSrc, (int)UnityEngine.Rendering.BlendMode.SrcAlpha);
                    fxMatComposeGlow.SetInt(ShaderParams.BlendDst, (int)UnityEngine.Rendering.BlendMode.OneMinusSrcAlpha);
                }
