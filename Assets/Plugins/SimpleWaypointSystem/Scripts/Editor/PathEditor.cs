...
namespace SWS
{
    ...
    public class PathEditor : Editor
    {
        ...
        //currently selected waypoint nodes for position/rotation editing
        ...
        //tracking of last mouse button click, working around Unity behavior calling
        //OnSceneGUI multiple times per frame thus resetting mouse clicks instantly
        private double lastMouseClickTime = 1;
        //tracking of keyboard modifiers pressed
        ...
        */
        ...
        void OnSceneGUI()
        {
            ...
            for (int i = 0; i < waypoints.Length; i++)
            {
                ...
                var fmh_299_47_638520146019943688 = Quaternion.identity; Handles.FreeMoveHandle(wpPos, size, Vector3.zero, (controlID, position, rotation, hSize, eventType) => 
                {
