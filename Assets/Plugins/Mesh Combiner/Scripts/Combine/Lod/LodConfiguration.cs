...
namespace TeoGames.Mesh_Combiner.Scripts.Combine.Lod {
	...
	public class LodConfiguration {
		...
		[Tooltip("LODs will be split into 3D chunks if true")]
		...
		public void Init(AbstractMeshCombiner original) {
			...
			_Combiner.chunk.Init(
				...
				bakeMaterials: original.bakeMaterials,
				separateBlendShapes: original.separateBlendShapes,
				clearMaterialCache: original.clearMaterialCache
			);
