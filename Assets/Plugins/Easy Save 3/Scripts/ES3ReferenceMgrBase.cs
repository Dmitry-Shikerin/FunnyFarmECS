...
namespace ES3Internal
{
    ...
    public abstract class ES3ReferenceMgrBase : MonoBehaviour
    {
        ...
        public static ES3ReferenceMgrBase GetManagerFromScene(Scene scene)
        {
            ...
            // Note that the buildIndex will be -1 if we're not in playmode and we're in a scene which isn't in the build list.
            if (Application.isPlaying && scene.buildIndex == -1)
            {
