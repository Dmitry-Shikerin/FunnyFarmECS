...
namespace FIMSpace.FOptimizing
{
    ...
    public partial class Optimizer_BaseEditor : Editor
    {
        ...
        [MenuItem("CONTEXT/Optimizer_Base/Select Optimizers Settings File")]
        protected static void SelectOptimizersSetup(MenuCommand menuCommand)
        {
            var setup = OptimizersSetup.Settings;
            if (setup == null) UnityEngine.Debug.Log("Can't detect Optimizers Settings File! This shouldn't happen!");
            else Selection.activeObject = setup;
        }
