...
namespace FIMSpace.FOptimizing
{
    ...
    public class OptimizerEditorTerrain : ScriptableOptimizerEditor
    {
        ...
        private SerializedProperty sp_ExtraRadiusSize;
        ...
        protected override void OnEnable()
        {
            ...
            sp_ExtraRadiusSize = serializedObject.FindProperty("ExtraRadiusSize");
        ...
        protected override void El_ContainerSwitch()
        {
            ...
            EditorGUILayout.PropertyField(sp_ExtraRadiusSize);
            if (sp_ExtraRadiusSize.floatValue < 0f) sp_ExtraRadiusSize.floatValue = 0f;
