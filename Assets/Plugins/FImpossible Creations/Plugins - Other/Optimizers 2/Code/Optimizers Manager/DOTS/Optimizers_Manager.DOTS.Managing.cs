...
namespace FIMSpace.FOptimizing
{
    public partial class OptimizersManager
    {
        ...
        public void DOTS_AddOptimizer(Optimizer_Base optimizer)
        {
            ...
            if (OptimizersSetup.Settings.UseProgressiveCulling == false) return;
            ...
            if (Settings.SupportNotObstacles == false) if (isObstacle == false) return; // If not supporting not obstacles then disabling occlusion on object
            ...
            if (optimizer.DOTSDetection == EDOTSDetection.Custom)
            {
                ...
                foreach (var rf in refs)
                {
                    ...
                    rf.Parent = optimizer;
                    rf.gameObject.layer = Settings.OptimizersCullingLayer;
                }
            }
            else
