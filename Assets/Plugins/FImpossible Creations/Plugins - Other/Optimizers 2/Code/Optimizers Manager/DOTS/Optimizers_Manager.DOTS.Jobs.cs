    ...
    public partial class OptimizersManager
    {
        ...
        private void DOTS_ScheduleRaycasting()
        {
            ...
            CreateRayCommandsJob rayJobs = new CreateRayCommandsJob
            {
                ...
                mask = Settings.ProgressiveCullingMask,
                rayCommands = dots_RayCommands
            };

            dots_JobHandles.Add(rayJobs.Schedule(Settings.ProgressiveResponseQuality, 64, default));

            // Triggering Jobs ------------------------------
            dots_Progressed += Settings.ProgressiveResponseQuality;
            if (dots_Progressed >= (dots_Rays.Length - Settings.ProgressiveResponseQuality)) dots_Progressed = 0;
