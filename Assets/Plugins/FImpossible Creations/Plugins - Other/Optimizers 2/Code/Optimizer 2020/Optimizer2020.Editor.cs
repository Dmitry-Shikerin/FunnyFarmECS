    ...
    public partial class Optimizer2
    {
        ...
        public override void AssignComponentsToOptimizeFrom(Component target, bool includeAdvanced = false)
        {
            ...
            for (int i = 0; i < allOnTarget.Length; i++)
            {
                ...
                var instance = LODInstanceGenerator.GenerateInstanceOutOf(this, allOnTarget[i], true, includeAdvanced ? LODInstanceGenerator.ESearchMode.AllComponents : LODInstanceGenerator.ESearchMode.JustUnityComponents, false);
        ...
        public override void AssignCustomComponentToOptimize(MonoBehaviour target)
        {
            ...
            for (int i = 0; i < allOnTarget.Length; i++)
            {
                var instance = LODInstanceGenerator.GenerateInstanceOutOf(this, allOnTarget[i], true, LODInstanceGenerator.ESearchMode.JustCustomComponents, false);
                if (instance == null) continue;
