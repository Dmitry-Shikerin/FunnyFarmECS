...
namespace FIMSpace.FOptimizing
{
    public static partial class LODInstanceGenerator
    {
        ...
        /// <returns></returns>
        public static ILODInstance GenerateInstanceOutOf(Optimizer2 callFrom, Component component, bool deepSearch = true, ESearchMode toIdentify = ESearchMode.AllComponents, bool isInitializing = false)
        {
