...
namespace Sources.BoundedContexts.CowPens.Controllers
{
    public class CowPenPresenter : PresenterBase
    {
        private readonly CowPen _cowPen;
        private readonly Inventory _inventory;
        private readonly CowPenView _view;
        private readonly ICameraService _cameraService;
        private readonly ISelectableService _selectableService;

        private CancellationTokenSource _token;

        public CowPenPresenter(
            string id,
            CowPenView view,
        ...
        {
            _cowPen = entityRepository.Get<CowPen>(id);
