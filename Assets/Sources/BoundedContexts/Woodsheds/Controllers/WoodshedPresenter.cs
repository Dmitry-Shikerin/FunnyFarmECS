...
namespace Sources.BoundedContexts.Woodsheds.Controllers
{
    public class WoodshedPresenter : PresenterBase
    {
        private readonly Woodshed _tomatoPatch;
        private readonly Inventory _inventory;
        private readonly WoodshedView _view;
        private readonly ICameraService _cameraService;
        private readonly ISelectableService _selectableService;

        private CancellationTokenSource _token;

        public WoodshedPresenter(
            string id,
            WoodshedView view,
        ...
        {
            _tomatoPatch = entityRepository.Get<Woodshed>(id);
