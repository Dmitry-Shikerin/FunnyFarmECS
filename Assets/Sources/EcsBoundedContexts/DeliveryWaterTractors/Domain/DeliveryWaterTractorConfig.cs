...
{
    [CreateAssetMenu(fileName = nameof(DeliveryWaterTractorConfig), menuName = "Configs/" + nameof(DeliveryWaterTractorConfig))]
    public class DeliveryWaterTractorConfig : Config
    {
