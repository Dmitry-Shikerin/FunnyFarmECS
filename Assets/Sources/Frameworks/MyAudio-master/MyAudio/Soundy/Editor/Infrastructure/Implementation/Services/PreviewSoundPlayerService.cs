...
{
    public class PreviewSoundPlayerService : IPreviewSoundPlayerService
    {
        private readonly IEditorUpdateService _updateService;
        ...
        public PreviewSoundPlayerService(IEditorUpdateService updateService)
        {
            _updateService = updateService ?? throw new ArgumentNullException(nameof(updateService));
            _soundController = Object.FindFirstObjectByType<SoundyController>() ??
