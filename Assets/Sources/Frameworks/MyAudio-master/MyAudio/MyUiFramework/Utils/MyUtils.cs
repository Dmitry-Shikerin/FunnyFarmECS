...
namespace MyAudios.MyUiFramework.Utils
{
    public static class MyUtils
    {
        ...
        public static GameObject CreateGameObjectWithAnImageComponent(
            string objectName, Color color, GameObject parent = null)
        {
        ...
        public static GameObject CreateBackgroundImage(GameObject parent) =>
            CreateGameObjectWithAnImageComponent(BACKGROUND, BackgroundColor, parent);
        
        public static GameObject CreateOverlayImage(GameObject parent) =>
            CreateGameObjectWithAnImageComponent(OVERLAY, OverlayColor, parent);
        ...
        public static T AddToScene<T>(
            string gameObjectName, bool isSingleton, bool selectGameObjectAfterCreation = false) 
...
//            Debug.Log("assetObject is null? " + (assetObject == null));
            ...
            if (objectToAdd == null || assetObject == null)
                return;
