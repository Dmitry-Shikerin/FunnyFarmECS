...
namespace Sources.Frameworks.MyLocalization.Presentation.Implementation
{
    [RequireComponent(typeof(TextMeshProUGUI))]
    public class UiLocalizationText : View, ISelfValidator
    {
        ...
        [SerializeField] private Enable _disableTexts = UiFramework.Core.Presentation.CommonTypes.Enable.Disable;
        [TabGroup("GetId", "Translations")] 
        [TextArea(1, 20)] [Space(10)] 
        [DisableIf("_disableTexts", UiFramework.Core.Presentation.CommonTypes.Enable.Disable)]
