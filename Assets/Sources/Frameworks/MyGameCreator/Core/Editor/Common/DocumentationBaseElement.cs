...
using Sources.Frameworks.MyGameCreator.Core.Runtime;
...
namespace Sources.Frameworks.MyGameCreator.Core.Editor.Common
{
    ...
    {
        public const string PATH_USS = 
            "Assets/Sources/Frameworks/MyGameCreator/Core/Editor/Common/Documentation/Styles/Documentation";
